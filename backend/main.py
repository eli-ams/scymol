...
import backend_static_functions
import inputs
import log_functions
from lammps_stages import LammpsStages
...
class JobRunner:
    def __init__(self, job_id: str) -> None:
        ...
        try:
            ...
            os.makedirs(f"output/{args.id}/", exist_ok=False)
    ...
    def create_log_file(self) -> str:
        ...
        log_file = log_functions.create_log_file(
            logdir=f"output/{self.job_id}/", constant=True
        )
        return log_file
    ...
    def create_directories(self) -> None:
        ...
        if inputs.run_mode == "mixture+pysimm+lammps":
            ...
            os.makedirs(
                f"output/{self.job_id}/mixture_{self.nbr_of_mixtures_accepted}/",
                exist_ok=True,
            )
    ...
    def run(self) -> None:
        ...
        backend_static_functions.clear_folder(folder_path=f"output/{self.job_id}/")
