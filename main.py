...
from front2back.backend_connector import BackendConnector
from frontend.context_menus.load_molecules import LoadMoleculesContextMenu
from frontend.main_window.menubar import Menubar
from frontend.main_window.tab1 import Tab1
from frontend.main_window.tab2 import Tab2
from frontend.main_window.tab3 import Tab3
from frontend.main_window.tab4 import Tab4
from frontend.main_window.tab5 import Tab5
from frontend.settingsfile import SettingsFile

Ui_MainWindow, BaseMainWindow = uic.loadUiType("frontend/uis/main_window.ui")
...
class MainWindow(BaseMainWindow):
    ...
    def load_ui(self) -> None:
        ...
        :rtype: None
        """
        uic.loadUi("frontend/uis/main_window.ui", self)
