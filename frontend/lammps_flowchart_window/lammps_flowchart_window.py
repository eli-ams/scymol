...
from frontend.custom_qtwidgets.list_of_lammps_substages import ListOfLammpsSubstages
from frontend.lammps_flowchart_window.dialog_windows.initialize import (
    LammpsInitializeSubstage,
)
from frontend.lammps_flowchart_window.dialog_windows.minimize import (
    LammpsMinimizeSubstage,
)
from frontend.lammps_flowchart_window.dialog_windows.velocities import (
    LammpsVelocitiesSubstage,
)
from frontend.lammps_flowchart_window.dialog_windows.nvt import LammpsNvtSubstage
from frontend.lammps_flowchart_window.dialog_windows.npt import LammpsNptSubstage
from frontend.lammps_flowchart_window.dialog_windows.nve import LammpsNveSubstage
from frontend.lammps_flowchart_window.dialog_windows.uniaxial_deformation import (
    LammpsUniaxialDeformation,
)


Ui_FlowChartWindow, _ = uic.loadUiType("frontend/uis/pop_window.ui")
