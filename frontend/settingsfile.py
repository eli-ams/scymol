...
class SettingsFile:
    ...
    def create_default_settings(self) -> None:
        ...
        self.settings = {
            ...
            "lammps_location": "../../../lammps+mpi/lmp_mpi",
            "mpi_location": "../../../lammps+mpi/mpiexec",
            "recent_files": [],
        }
        if os.name == "nt":  # for Windows
            print_to_log("Loading settings for Windows-like systems")
            self.settings["lammps_location"] = "../../../lammps+mpi/lammps.exe"
            # The -localonly flag is necessary for Windows systems to run MPI tasks locally,
            # without requiring elevation.
            self.settings["mpi_location"] = "../../../lammps+mpi/mpiexec.exe -localonly"
        else:  # Unix and Unix-like platforms
            print_to_log("Loading settings for Unix-like systems")
            self.settings["lammps_location"] = "../../../lammps+mpi/lammps"
            self.settings["mpi_location"] = "../../../lammps+mpi/mpiexec"
