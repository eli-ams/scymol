...
from scymol.frontend.main_window.lammps_syntax_highlighter import (
    LammpsSyntaxHighlighter,
)
from scymol.frontend.main_window.custom_table_widget import CustomTableWidget
from scymol.frontend.main_window.instantaneous_properties_file import (
    InstantaneousPropertiesClass,
)
from scymol.frontend.main_window.trajectories_file_class import (
    TrajectoriesClass,
)
...
class Tab5(QWidget):
    ...
    def initialize_widgets(self) -> None:
        ...
        start_directory = str(importlib.resources.files("scymol").joinpath("output"))
