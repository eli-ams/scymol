...
from front2back import validate_inputs
from front2back.backend_thread import BackendThread
from front2back.running_process_dialog import RunningProcessDialog
...
class BackendConnector:
    ...
    def run_backend_thread(self, callback: Callable) -> None:
        ...
        Returns:
            None
        """
        command = [sys.executable, "backend/main.py", "--id", f"{self.job_id}"]
